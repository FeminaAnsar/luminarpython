var isl_2020= [{ team: "Mumbai City FC", match: 16, won: 10, drawn: 4, lost: 2, gf: 25, ga: 11, gd: 14, points: 34 },
...
isl_2020.sort((obj1,obj2)=>obj1.match>obj2.match?1:-1).forEach(obj=>console.log(obj))
const high=isl_2020.map(obj=>obj.points).reduce((obj1,obj2)=>obj1>obj2?obj1:obj2)
console.log(high);
